...
url = 'https://quotes.toscrape.com/' # quotes

downloaded = trafilatura.fetch_url(url)
# print(trafilatura.extract(downloaded))
#------------------------
# import re
# corpus = trafilatura.extract(downloaded)

# # 인용구 추출
# text_list = re.findall(r'“([^”]+)”', corpus)
# # 작가명 추출
# author_list = re.findall(r'by ([^\n]+)', corpus)

# print("text =", text_list)
# print("author =", author_list)

# import pandas as pd
# df = pd.DataFrame({'text': text_list, 'author': author_list})
# print(df)
